...
/**
 * Web / non–native-iOS paywall: Stripe Checkout + Customer Portal only.
 */
export default function SubscriptionStripe() {
  ...
  const hasTextSimAddon = Boolean(subscription?.has_text_simulator);
  const hasDetachmentAddon = Boolean(subscription?.has_detachment_plan);
      ...
      <div className="container max-w-lg mx-auto px-4 py-6 sm:py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-sm">
            Simple pricing — one plan, optional add-ons. Powered by Stripe.
          </p>
        </div>
        ...
        <Card className={`relative overflow-hidden mb-6 ${isUnlimited ? "ring-2 ring-primary shadow-md" : "border-2 border-primary/40"}`}>
          ...
          <CardContent className="pt-4">
            ...
            <Button
              ...
              onClick={() => void handleCheckout(STRIPE_PLANS.unlimited.price_id)}
            >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="font-bold text-foreground">
                      $5<span className="text-xs font-normal text-muted-foreground">/mo</span>
                    </span>
                  </div>
                  ...
                  <Button
                    ...
                    onClick={() => void handleCheckout(STRIPE_ADDONS.text_simulator.price_id)}
                  >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Button
                    ...
                    onClick={() => void handleCheckout(STRIPE_ADDONS.detachment_plan.price_id)}
                  >
