            ...
            {!isForgotPassword && (
              <div className="space-y-3">
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 rounded-xl bg-background/50 hover:bg-background/80 border-border/50 text-base font-semibold gap-2"
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (result.error) {
                        toast({ title: result.error.message || "Google sign in failed", variant: "destructive" });
                      }
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (result.error) {
                        toast({ title: result.error.message || "Apple sign in failed", variant: "destructive" });
                      }
                      if (result.redirected) return;
                    } catch (err) {
