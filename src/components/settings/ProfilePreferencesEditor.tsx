...
import { 
  ...
  Home, AlertTriangle, Plus, Trash2
} from "lucide-react";
...
// Past relationship types and options (matching intake)
        ...
        <AccordionItem value="past_relationships" data-value="past_relationships" className="border rounded-lg px-4">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center gap-2 flex-1">
              ...
              {(() => {
                const relationships = (formData as any).past_relationship_traumas as PastRelationship[] || [];
                return relationships.length > 0 && (
                  <span className="text-xs bg-muted px-2 py-0.5 rounded-full ml-2">
                    {relationships.length} added
                  </span>
                );
              })()}
            </div>
          ...
          <AccordionContent className="space-y-4 pb-4">
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 text-xs text-muted-foreground">
              ...
              This section is optional but helps D.E.V.I. understand patterns that may affect your dating life. Skip entirely or add only what feels comfortable.
            </div>
            ...
            {(() => {
              ...
              const addRelationship = () => {
                ...
                updateField("past_relationship_traumas" as any, [...relationships, newRel]);
              };
              
              const removeRelationship = (id: string) => {
                updateField("past_relationship_traumas" as any, relationships.filter(r => r.id !== id));
              };
              ...
              const updateRelationship = (id: string, field: keyof PastRelationship, value: any) => {
                ...
                updateField("past_relationship_traumas" as any, updated);
              };
